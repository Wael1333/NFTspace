...
const EventitemNewList = ({ event, eventcode }) => {
  console.log("Lisitng ID", eventcode);
  return (
    <>
        ...
        <div className={style.eventItem}>
          <>
            <div className={`${style.event} flex-[2]`}>
              ...
              <div className={style.eventName}>Listing created</div>
            </div>
...
export default EventitemNewList;
